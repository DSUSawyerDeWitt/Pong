...
class Opponent(Paddle):
    ...
    def get_direction(self):
        self.direction = 1 if self.ball.rect.y > self.rect.y else -1
...
class Ball(pygame.sprite.Sprite):
    def __init__(self, groups, paddle_sprites, update_score):
        ...
        self.duration = 1200 # 1.2 seconds
    ...
    def collision(self, direction):
        for sprite in self.paddle_sprites:
            if sprite.rect.colliderect(self.rect):
                if direction == 'horizontal': #rect is ball, sprite is the paddles
    ...
    def timer(self): #Timer to start the ball moving
